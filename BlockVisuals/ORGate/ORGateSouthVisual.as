package BlockVisuals.ORGate{
	import flash.display.MovieClip;
	import flash.utils.getQualifiedClassName;
	import flash.utils.getDefinitionByName;
	
	public class ORGateSouthVisual extends MovieClip{
		public var script:Object;
		public const specialTags = ["Receiver", "Transmitter"];
		
		public function ORGateSouthVisual(inputtedScript):void{ //Sets the block coordinates
