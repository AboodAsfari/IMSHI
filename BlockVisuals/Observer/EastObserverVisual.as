package BlockVisuals.Observer{
	...
	public class EastObserverVisual extends MovieClip{
		public var script:Object;
		public const specialTags = ["Transmitter"];
		
		public function EastObserverVisual(inputtedScript):void{ //Sets the block coordinates
		...
		public function RequestConnection(requester, column, row, connectionRole):Boolean{
			if(connectionRole.indexOf("Transmitter") != -1 && row == script.row && column == script.column - 1){
				return true;
			}else{
				return false;
			}
