package Blocks.ORGate{
	...
	public class ORGateWest extends BlockBase{
		...
		public function ORGateWest(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
		...
		public function TransmitSignal(strength, signalSource, sourceDirection):void{ //Transmits a power signal
			if(sourceDirection[0] != 1){
				...
				if(eastInput != 0 || northInput != 0 || southInput != 0){
					if(power == 0){
						power++;
