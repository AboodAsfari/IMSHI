package Blocks.ORGate{
	...
	public class ORGateEast extends BlockBase{
		...
		public function ORGateEast(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
		...
		public function TransmitSignal(strength, signalSource, sourceDirection):void{ //Transmits a power signal
			if(sourceDirection[0] != -1){
				...
				if(westInput != 0 || northInput != 0 || southInput != 0){
					if(power == 0){
						power++;
