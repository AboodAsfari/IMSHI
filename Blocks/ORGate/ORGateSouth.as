package Blocks.ORGate{
	...
	public class ORGateSouth extends BlockBase{
		...
		public function ORGateSouth(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
		...
		public function TransmitSignal(strength, signalSource, sourceDirection):void{ //Transmits a power signal
			if(sourceDirection[1] != -1){				
				...
				if(westInput != 0 || northInput != 0 || eastInput != 0){
					if(power == 0){
						power++;
