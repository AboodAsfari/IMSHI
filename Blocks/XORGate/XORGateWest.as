package Blocks.XORGate{
	import flash.utils.getQualifiedClassName;
	import flash.utils.getDefinitionByName;
	import flash.events.Event;
	
	public class XORGateWest extends BlockBase{
		...
		public function XORGateWest(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
		...
		public function TransmitSignal(strength, signalSource, sourceDirection):void{ //Transmits a power signal
			if(sourceDirection[0] != 1){
				...
				var offInputs:Number = 0;
				if(southInput == 0){offInputs++;}
				if(northInput == 0){offInputs++;}
				if(eastInput == 0){offInputs++;}
