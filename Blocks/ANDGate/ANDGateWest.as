package Blocks.ANDGate{
	...
	public class ANDGateWest extends BlockBase{
		...
		public function ANDGateWest(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the gate visuals 
		...
		public function TransmitSignal(strength, signalSource, sourceDirection):void{ //Transmits a power signal
			if(sourceDirection[0] != 1){
				...
				if((eastInput != 0 || !visual.connector.wireRight.visible) && (northInput != 0 || !visual.connector.wireTop.visible) && (southInput != 0 || !visual.connector.wireBottom.visible)){
					if(power == 0){
						power++;
