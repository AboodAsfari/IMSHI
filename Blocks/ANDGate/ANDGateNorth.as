package Blocks.ANDGate{
	...
	public class ANDGateNorth extends BlockBase{
		...
		public function ANDGateNorth(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the gate visuals 
		...
		public function TransmitSignal(strength, signalSource, sourceDirection):void{ //Transmits a power signal
			if(sourceDirection[1] != 1){
				...
				if((westInput != 0 || !visual.connector.wireLeft.visible) && (eastInput != 0 || !visual.connector.wireRight.visible) && (southInput != 0 || !visual.connector.wireBottom.visible)){
					if(power == 0){
						power++;
