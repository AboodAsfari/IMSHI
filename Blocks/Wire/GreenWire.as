package Blocks.Wire{
	...
	public class GreenWire extends BlockBase{
		...
		public function GreenWire(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
			super(inputtedColumn, inputtedRow, this, ["Sub-Block", "Receiver", "Transmitter", "Wire", "Green"]); //See above
