package Blocks.Wire{
	...
	public class RedWire extends BlockBase{
		...
		public function RedWire(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
			super(inputtedColumn, inputtedRow, this, ["Sub-Block", "Receiver", "Transmitter", "Wire", "Red"]); //See above
