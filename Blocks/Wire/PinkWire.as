package Blocks.Wire{
	...
	public class PinkWire extends BlockBase{
		...
		public function PinkWire(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
			super(inputtedColumn, inputtedRow, this, ["Sub-Block", "Receiver", "Transmitter", "Wire", "Pink"]); //See above
