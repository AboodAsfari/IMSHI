package Blocks.Wire{
	...
	public class BlueWire extends BlockBase{
		...
		public function BlueWire(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
			super(inputtedColumn, inputtedRow, this, ["Sub-Block", "Receiver", "Transmitter", "Wire", "Blue"]); //See above
