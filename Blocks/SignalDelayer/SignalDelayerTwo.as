package Blocks.SignalDelayer{
	...
	public class SignalDelayerTwo extends BlockBase{
		...
		private const delayAmount:Number = 500;
		
		public function SignalDelayerTwo(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
