package Blocks.SignalDelayer{
	...
	public class SignalDelayerThree extends BlockBase{
		...
		private const delayAmount:Number = 750;
		
		public function SignalDelayerThree(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
