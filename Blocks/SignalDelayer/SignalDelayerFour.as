package Blocks.SignalDelayer{
	...
	public class SignalDelayerFour extends BlockBase{
		...
		private const delayAmount:Number = 1000;
		
		public function SignalDelayerFour(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the rock visuals 
