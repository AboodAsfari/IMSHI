package Blocks.Piston{
	...
	public class NorthPiston extends BlockBase{	
		...
		public function NorthPiston(inputtedColumn, inputtedRow, inputtedID):void{ //Sets up the yellow plate's visuals 
		...
		private function PistonAnimator(e:Event){
			if(power > 0 && (visualState == "Off" || (visualState == "On" && (visual.currentFrame > 8 || visual.currentFrame == 1)))){
				...
				var retractionTile:Object = TileDatabase.GetTile(column, row - 2);
